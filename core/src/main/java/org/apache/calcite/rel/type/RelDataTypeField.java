...
public interface RelDataTypeField extends Map.Entry<String, RelDataType> {
  ...
  class ToFieldIndex
      implements org.apache.kylin.guava30.shaded.common.base.Function<RelDataTypeField, Integer> {
  ...
  @SuppressWarnings("nullability")
  class ToFieldName
      implements org.apache.kylin.guava30.shaded.common.base.Function<RelDataTypeField, String> {
